...
<div class="row">
	<div class="col-md-3">
		<a class="btn btn-box btn-success">
			<i class="fa fa-plus"></i> 新增
		</a>
		<a class="btn btn-box btn-info">
...
<div class="row">
	<form class="form-inline" action="/admin/menu" method="get">
		<div class="col-md-12">
			<div class="box">
				...
				<div class="box-body table-responsive">
					...
					<div class="form-group">
						<input type="text" class="form-control" id="created_at" name="created_at" value="{{date('Y/m/d').' - '.date('Y/m/d',strtotime("+1 week"))}}">
					</div>
				</div>
...
$(function(){
	$('.select2').select2();
	$('#created_at').daterangepicker({timePickerIncrement: 30, format: 'YYYY/MM/DD'});
});
</script>
@endsection
