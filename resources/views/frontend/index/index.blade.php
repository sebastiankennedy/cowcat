...
<head>
    ...
    <meta name="keywords" content="CowCat,奶牛猫,Laravel,CMS,Laravel CMS">
...
<section class="main-header">
    ...
    <div id="owl-hero" class="owl-carousel owl-theme">
        <div class="item" style="background-image: url(/assets/frontend/img/sliders/Slide.jpg)">
            <div class="caption">
        ...
        <div class="item" style="background-image: url(/assets/frontend/img/sliders/Slide2.jpg)">
            <div class="caption">
                <h6>Branding / Design / Creativty</h6>
        ...
        <div class="item" style="background-image: url(/assets/frontend/img/sliders/Slide3.jpg)">
            <div class="caption">
                <h6>Branding / Design / Creativty</h6>
...
<section id="welcome">
    <div class="container">
        ...
        <img class="img-responsive center-block wow fadeInUp" data-wow-delay=".3s" src="/assets/frontend/img/welcome/logo.png" alt="logo">
    </div>
</section>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                <a class="portfolio-box" href="/assets/frontend/img/portfolio/1.jpg" data-lightbox="image-1" data-title="Your caption">
                    <img src="/assets/frontend/img/portfolio/1.jpg" class="img-responsive" alt="1">
            ...
            <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                <a href="/assets/frontend/img/portfolio/2.jpg" class="portfolio-box" data-lightbox="image-2" data-title="Your caption">
                    <img src="/assets/frontend/img/portfolio/2.jpg" class="img-responsive" alt="2">
                    <div class="portfolio-box-caption">
                        <div class="portfolio-box-caption-content">
                            <div class="project-category text-faded">
                                Category
            ...
            <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                <a href="/assets/frontend/img/portfolio/3.jpg" class="portfolio-box" data-lightbox="image-3" data-title="Your caption">
                    <img src="/assets/frontend/img/portfolio/3.jpg" class="img-responsive" alt="3">
                    <div class="portfolio-box-caption">
                        <div class="portfolio-box-caption-content">
                            <div class="project-category text-faded">
                                Category
            ...
            <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                <a href="/assets/frontend/img/portfolio/4.jpg" class="portfolio-box" data-lightbox="image-4" data-title="Your caption">
                    <img src="/assets/frontend/img/portfolio/4.jpg" class="img-responsive" alt="4">
                    <div class="portfolio-box-caption">
                        <div class="portfolio-box-caption-content">
                            <div class="project-category text-faded">
                                Category
            ...
            <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                <a href="/assets/frontend/img/portfolio/5.jpg" class="portfolio-box" data-lightbox="image-5" data-title="Your caption">
                    <img src="/assets/frontend/img/portfolio/5.jpg" class="img-responsive" alt="5">
                    <div class="portfolio-box-caption">
                        <div class="portfolio-box-caption-content">
                            <div class="project-category text-faded">
                                Category
            ...
            <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                <a href="/assets/frontend/img/portfolio/6.jpg" class="portfolio-box" data-lightbox="image-6" data-title="Your caption">
                    <img src="/assets/frontend/img/portfolio/6.jpg" class="img-responsive" alt="6">
                    <div class="portfolio-box-caption">
                        <div class="portfolio-box-caption-content">
                            <div class="project-category text-faded">
                                Category
...
<section id="team">
    <div class="container">
        ...
        <div class="row wow fadeInUp" data-wow-delay=".3s">
            <div class="col-md-4">
                <div class="team">
                    <img class="img-responsive center-block" src="/assets/frontend/img/team/MariaDoe.jpg" alt="1">
                    <h4>Maria Doe</h4>
                    <p>Designer</p>
            ...
            <div class="col-md-4">
                <div class="team">
                    <img class="img-responsive center-block" src="/assets/frontend/img/team/JasonDoe.jpg" alt="2">
                    <h4>Jason Doe</h4>
                    <p>Developer</p>
                    <div class="team-social-icons">
                        <a href="#"><i class="fa fa-facebook"></i></a>
            ...
            <div class="col-md-4">
                <div class="team">
                    <img class="img-responsive center-block" src="/assets/frontend/img/team/MikeDoe.jpg" alt="3">
                    <h4>Mike Doe</h4>
                    <p>Photographer</p>
                    <div class="team-social-icons">
                        <a href="#"><i class="fa fa-facebook"></i></a>
